<nav class="flex flex-nowrap">
    <ul class="navHeader__ul flex flex-wrap ml-5">
        ...
        <li class="navHeader__li ml-5"><a class="navHeader__a" href="/news">News</a></li>
        ...
        <li class="navHeader__li ml-5"><a class="navHeader__a" href="/order/create">Форма для получения выгрузки данных</a></li>
    </ul>
</nav>
